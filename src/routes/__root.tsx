...
export const Route = createRootRoute({
  ...
  head: () => ({
    ...
    links: [
      ...
      { rel: "dns-prefetch", href: "https://img.sofascore.com" },
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Instrument+Serif:ital@1&family=Plus+Jakarta+Sans:wght@400;600;700&display=swap",
      },
    ],
  }),
